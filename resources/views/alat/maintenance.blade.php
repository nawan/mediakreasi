    ...
    $(function() {
        ...
        var table = $('#daftar-maintenance').DataTable({
            ...
            language: {
                ...
                "sZeroRecords":  "Daftar Maintenance Alat Masih Kosong",
...
<ol class="mb-4 breadcrumb">
    ...
    <div class="card mt-10 mb-5">
        <div class="card-header text-center fw-bold text-uppercase mb-10 bg-dark text-white">
            Daftar Maintenance Alat
        </div>
        <div class="card-body">
            <table class="table table-bordered table-hover text-center align-middle stripe" id="daftar-maintenance" style="width:100%;">
