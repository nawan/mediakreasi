...
<script type="text/javascript">
    $(function() {
        ...
        var table = $('#buktibayar').DataTable({
            responsive: true,
            rowReorder: {
            ...
            columns: [{
                ...
                },
                {
                    ...
                    render: function(data, type, full, meta) {
                        if (data == 'LUNAS') {
                            return "<span class=\"badge bg-info text-uppercase\">BAYAR LUNAS</span>";
                        } 
                        else if (data == 'DP') {
                            return "<span class=\"badge bg-warning text-uppercase\">BAYAR DP</span>";
                        } 
                        else if (data == 'PELUNASAN') {
                            return "<span class=\"badge bg-success text-uppercase\">BAYAR PELUNASAN</span>";
                        } 
                        else if (data == 'DP(LUNAS)') {
                            return "<span class=\"badge bg-warning text-uppercase\">BAYAR DP</span>";
                        } 
                        else {
                            return "<span class=\"badge bg-info text-uppercase\">BELUM BAYAR</span>";
                        }
                    }
                },
                {
...
<ol class="mb-4 breadcrumb">
    ...
    <div class="card mt-10 mb-5">
        ...
        <div class="card-body">
            <table class="table table-bordered table-hover text-center align-middle stripe" id="buktibayar" style="width:100%;">
