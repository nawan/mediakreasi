        ...
        var table = $('#data-client').DataTable({
            ...
            columns: [{
                ...
                },
                {
                    ...
                    name: 'image',
                    render: function(data, type, full, meta) {
                        return "<img src=\"storage/" + data + "\" width=\"80\" height=\"100\"/>";
                    },
                    orderable: true,
                    searchable: true
                },
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Data Crew</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
    ...
    <div class="card mt-10 mb-5">
        ...
        <div class="card-body">
            <div class="d-flex mt-4 mb-3">
                <a href="{{ route('crew.create') }}" class="btn btn-primary btn-sm"><i class="fa fa-plus-square"></i> Tambah Data Crew</a>
            </div>
