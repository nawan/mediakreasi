...
<ol class="mb-4 breadcrumb">
    ...
    <div class="card mt-10 mb-5">
        <div class="card-header text-center fw-bold text-uppercase mb-10 bg-warning text-white">
            Edit Data Crew Atas Nama {{ $user->name }}
        </div>
        <div class="card-group">
            <div class="card-body">
                <form action="{{ route('crew.update', $user->id) }}" method="POST" enctype="multipart/form-data">
                @csrf()
                @method('PUT')
                <div class="row">
                ...
                <div class="d-flex justify-content-end mt-3 gap-2">
                    <a href="{{ route('crew.index') }}" class="btn btn-danger">Batal</a>
