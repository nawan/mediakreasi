...
{{-- datatables css --}}
<link rel="stylesheet" href="{{ URL::asset('assets/bootstrap-5/css/dataTables.jqueryui.min.css') }}">
{{-- datatables css --}}
...
<script type="text/javascript">
    $(function() {
        ...
        var table = $('#laporan-pembayaran').DataTable({
            responsive: true,
            dom: 'Blfrtip',
            lengthMenu: [
                [ 10, 25, 50, -1 ],
            ...
            columns: [{
                ...
                },
                {
                    ...
                    name: 'payment_amount',
                    render: function(data, type, full, meta) {
                        return "<span class=\"text-uppercase\">Rp "+ data +"</span>";
                    }
                },
                {
                    data: 'payment_proof',
                    name: 'payment_proof',
                    render: function(data, type, full, meta) {
                        return "<img src=\"storage/" + data + "\" width=\"150\">";
                    },
                    orderable: true,
                    searchable: true
                },
                {
                    ...
                    render: function(data, type, full, meta) {
                        ...
                        else if (data == 'DP(LUNAS)') {
                            return "<span class=\"badge bg-warning text-uppercase\">DOWNPAYMENT(LUNAS)</span>";
                        } 
                        else if (data == 'PELUNASAN') {
                            return "<span class=\"badge bg-success text-uppercase\">PELUNASAN</span>";
                        } 
                        else if (data == 'DP') {
                            return "<span class=\"badge bg-warning text-uppercase\">DOWNPAYMENT</span>";
                        } 
                        else {
...
<ol class="mb-4 breadcrumb">
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active"><a href="{{ route('laporan.pembayaran') }}">Data Client</a></li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
    ...
    <section class="content mb-10">
        <div class="card mt-10 mb-5">
            ...
            <div class="card-body">
                <table class="table table-bordered table-hover text-center align-middle stripe" id="laporan-pembayaran">
