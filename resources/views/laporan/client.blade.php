...
<script type="text/javascript">
    $(function() {
        ...
        var table = $('#laporan-client').DataTable({
            responsive: true,
            dom: 'Blfrtip',
            lengthMenu: [
                [ 10, 25, 50, -1 ],
...
<ol class="mb-4 breadcrumb">
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active"><a href="{{ route('laporan.client') }}">Data Client</a></li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
    ...
    <section class="content mb-10">
        <div class="card mt-10 mb-5">
            ...
            <div class="card-body">
                <table class="table table-bordered table-hover text-center align-middle stripe" id="laporan-client">
