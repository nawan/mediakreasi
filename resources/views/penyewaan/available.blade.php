...
<script type="text/javascript">
    $(function() {
        ...
        var table = $('#alat_tersedia').DataTable({
            responsive: true,
            rowReorder: {
...
<ol class="mb-4 breadcrumb">
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Alat Tersedia</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
    ...
    <div class="card mt-10 mb-5">
        ...
        <div class="card-body">
            <table class="table table-bordered table-hover text-center align-middle stripe" id="alat_tersedia" style="width:100%;">
