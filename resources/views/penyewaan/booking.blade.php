...
<ol class="mb-4 breadcrumb">
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('alat.tersedia') }}">Alat Tersedia</a></li>
    ...
    <div class="card mt-10 mb-5">
        <div class="card-header text-center fw-bold text-uppercase mb-10 bg-primary text-white">
            Booking Alat {{ $alat->name }}
        </div>
        <div class="card-group">
            <div class="card-body mt-3">
                <form action="{{ route('alat.booking_store', $alat->id) }}" method="POST" enctype="multipart/form-data" class="mb-4">
                    @csrf()
                        <div class="row">
                            <div class="mb-3 card-text form-group col-md-4">
                                ...
                                <option {{ (old('user_id') == $users->id ? 'selected' : '') }} value="{{ $users->id }}">{{ $users->name }}</option>
                                @endforeach
                                </select>
                                @error('user_id')
                        ...
                        <div class="row">
                            <div class="mb-3 card-text form-group col-md-4">
                                ...
                                <input type="number" class="form-control count-chars @error('price') is-invalid @enderror" name="price" id="price" value="{{ old('price', $alat->price) }}" maxlength="10" data-max-chars="10" hidden>
                        ...
                        <div class="mb-3 card-text">
                            ...
                            <textarea name="note" id="note" class="form-control text-capitalize count-chars @error('note') @enderror" maxlength="100" data-max-chars="100">{{ old('note_event') }}</textarea>
                            <div class="fw-light text-muted justify-content-end d-flex"></div>
                            @error('note')
                            <span class="invalid-feedback">
                            {{ $message }}
                        ...
                        <div class="d-flex justify-content-end mt-3 gap-2">
                            <a href="{{ route('alat.tersedia') }}" class="btn btn-danger">Batal</a>
