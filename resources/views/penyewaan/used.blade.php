...
<script type="text/javascript">
    $(function() {
        ...
        var table = $('#alat_terpakai').DataTable({
            responsive: true,
            rowReorder: {
                ...
                },
                {
                    ...
                    render: function(data) {
                        if (data == 'PAID') {
                            ...
                            return "<span class=\"badge bg-WARNING text-uppercase\">DOWN PAYMENT</span>";
                        } else {
...
<ol class="mb-4 breadcrumb">
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Alat Terpakai</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
    ...
    <div class="card mt-10 mb-5">
        ...
        <div class="card-body">
            <table class="table table-bordered table-hover text-center align-middle stripe" id="alat_terpakai" style="width:100%;">
                ...
                <div class="modal-content">
                    <div class="modal-header row d-flex">
                        <div class="justify-content-start col-md-6">
                            <h4 class="modal-title" id="myModalLabel"><i class="fa fa-info-circle"></i> Konfirmasi Pengembalian Alat</h4>
                        </div>
                    ...
                    <div class="modal-body">
                        <form action="{{ route('penyewaan.kembali') }}" method="POST">
                            ...
                            <div class="form-group">
                                <label for="note" class="form-label">Catatan Pengembalian Alat<span class="fst-italic text-danger" style="font-size: 0.8rem">*</span></label>
                            ...
                            <p class="fst-italic text-danger" style="font-size: 0.8rem">*wajib mengisi catatan riwayat penggunaan setelah disewa</p>
                            <br>
                            <div class="col-sm text-right">
                                <button type="submit" class="btn btn-outline-primary"><i class="far fa-check-circle"></i> Kembali</button>
                            </div>
                        </form>
                    </div>
                </div>
