...
<script>
    window.returnConfirm = function (e) {
    e.preventDefault();
    var form = e.target.form;
    swal({
        title: 'Apakah event telah selesai?',
        text: 'Status Event akan berubah jika Anda melanjutkan proses',
        icon: 'warning',
...
<script type="text/javascript">
    $(function() {
        ...
        var table = $('#event_berjalan').DataTable({
            responsive: true,
            rowReorder: {
...
<ol class="mb-4 breadcrumb">
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Event Berjalan</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
    ...
    <div class="card mt-10 mb-5">
        ...
        <div class="card-body">
            <table class="table table-bordered table-hover text-center align-middle stripe" id="event_berjalan" style="width:100%;">
