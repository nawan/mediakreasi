    ...
    <div class="card mt-10 mb-5">
        ...
        <div class="card-group">
            <div class="card-body mt-3">
                <form action="{{ route('event.store') }}" method="POST" enctype="multipart/form-data" class="mb-4">
                    @csrf()
                        <div class="row">
                            <div class="mb-3 card-text form-group col-md-9">
                                <label for="nama_event" class="form-label">Nama Event</label>
                                <input type="text" class="form-control count-chars text-uppercase @error('nama_event') is-invalid @enderror" id="nama_event" name="nama_event" value="{{ old('nama_event') }}" maxlength="70" data-max-chars="70">
                            ...
                            <div class="mb-3 card-text form-group col-md-3">
                                ...
                                <select class="form-select text-capitalize" id="tools_id" name="tools_id">
                        ...
                        <div class="mb-3 card-text">
                            ...
                            <textarea name="note" id="note" class="form-control text-capitalize count-chars @error('note') @enderror" maxlength="150" data-max-chars="150">{{ old('note') }}</textarea>
                            <div class="fw-light text-muted justify-content-end d-flex"></div>
                            @error('note')
                            <span class="invalid-feedback">
                            {{ $message }}
