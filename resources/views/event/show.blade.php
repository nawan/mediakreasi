    ...
    <div class="card mt-10 mb-5">
        ...
        <div class="card-body">
            <div class="card-body col-md-12">
                ...
                <div class="card-body bg-light">
                    ...
                    <div class="d-flex justify-content-end mt-3">
                        ...
                        @if($event->status_event == 'PENDING EVENT')
                        <a href="{{ route('event.edit', $encryptID) }}"class="btn btn-sm btn-warning m-1" title="Edit Event" data-toggle="tooltip" data-placement="top"><i class="fas fa-edit"></i></a>
                        @elseif($event->status_event == 'CANCELED EVENT')
                        <a href="{{ route('event.edit', $encryptID) }}"class="btn btn-sm btn-secondary m-1 disabled" title="Edit Event" data-toggle="tooltip" data-placement="top"><i class="fas fa-edit"></i></a>
                        @elseif($event->status_event == 'RETURNED EVENT')
                        <a href="{{ route('event.edit', $encryptID) }}"class="btn btn-sm btn-secondary m-1 disabled" title="Edit Event" data-toggle="tooltip" data-placement="top"><i class="fas fa-edit"></i></a>
            ...
            <div class="card-group">
                <div class="card-body text-center align-middle col-md-6">
                    ...
                    <div class="card-body bg-light overflow-auto" style="height: 400px">
                        ...
                        <div class="d-flex justify-content-end mt-3 gap-2">
                            @php $encryptID = Crypt::encrypt($event->id); @endphp
                            @if($event->status_event == 'PENDING EVENT')
                            <a href="{{ route('event.alat', $encryptID) }}"class="btn btn-sm btn-warning m-1" title="Edit Alat" data-toggle="tooltip" data-placement="top"><i class="fas fa-edit"></i></a>
                            @elseif($event->status_event == 'CANCELED EVENT')
                            <a href="{{ route('event.alat', $encryptID) }}"class="btn btn-sm btn-secondary m-1 disabled" title="Edit Alat" data-toggle="tooltip" data-placement="top"><i class="fas fa-edit"></i></a>
                            @elseif($event->status_event == 'RETURNED EVENT')
                            <a href="{{ route('event.alat', $encryptID) }}"class="btn btn-sm btn-secondary m-1 disabled" title="Edit Alat" data-toggle="tooltip" data-placement="top"><i class="fas fa-edit"></i></a>
                            @elseif($event->status_event == 'DONE')
                            <a href="{{ route('event.alat', $encryptID) }}"class="btn btn-sm btn-secondary m-1 disabled" title="Edit Alat" data-toggle="tooltip" data-placement="top"><i class="fas fa-edit"></i></a>
                ...
                <div class="card-body text-center align-middle col-md-6">
                    ...
                    <div class="card-body bg-light overflow-auto" style="height: 400px">
                        ...
                        <div class="d-flex justify-content-end mt-3 gap-2">
                            @php $encryptID = Crypt::encrypt($event->id); @endphp
                            @if($event->status_event == 'CANCELED EVENT')
                            <a href="{{ route('event.crew', $encryptID) }}"class="btn btn-sm btn-secondary disabled m-1" title="Edit Crew" data-toggle="tooltip" data-placement="top"><i class="fas fa-edit"></i></a>
                            @elseif($event->status_event == 'RETURNED EVENT')
                            <a href="{{ route('event.crew', $encryptID) }}"class="btn btn-sm btn-secondary disabled m-1" title="Edit Crew" data-toggle="tooltip" data-placement="top"><i class="fas fa-edit"></i></a>
                            @elseif($event->status_event == 'DONE')
                            <a href="{{ route('event.crew', $encryptID) }}"class="btn btn-sm btn-secondary disabled m-1" title="Edit Crew" data-toggle="tooltip" data-placement="top"><i class="fas fa-edit"></i></a>
                            ...
                            <a href="{{ route('event.crew', $encryptID) }}"class="btn btn-sm btn-secondary disabled m-1" title="Edit Crew" data-toggle="tooltip" data-placement="top"><i class="fas fa-edit"></i></a>
                            @else
                            <a href="{{ route('event.crew', $encryptID) }}"class="btn btn-sm btn-warning m-1" title="Edit Crew" data-toggle="tooltip" data-placement="top"><i class="fas fa-edit"></i></a>
                            @endif
                        </div>
                    </div>
                </div>
            ...
            <div class="d-flex justify-content-end mt-2">
                <a href="{{ route('event.index') }}" class="btn btn-primary">Selesai</a>
            </div>
        </div>
    </div>
    <br>
