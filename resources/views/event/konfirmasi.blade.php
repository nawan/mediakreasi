...
<ol class="mb-4 breadcrumb">
    ...
    <div class="card mt-10 mb-5">
        <div class="card-header text-center fw-bold text-uppercase mb-10 bg-primary text-white">
            Konfirmasi Event Telah Selesai
        </div>
        ...
        <div class="card-group">
            <div class="card-body">
                <div class="card-header text-center fw-bold text-uppercase bg-secondary text-white">
                    Konfirmasi Alat Kembali
                </div>
                <div class="card-body col-md-12 bg-light overflow-auto" style="height: 400px">
                    @php $encryptID = Crypt::encrypt($event->id); @endphp
                    <form action="{{ route('event.selesai', $encryptID) }}" method="POST" enctype="multipart/form-data">
                        @csrf()
                ...
                <div class="d-flex justify-content-end mt-3 gap-2">
                    <a href="{{ route('event.berjalan') }}" class="btn btn-danger">Batal</a>
                    <button type="submit" class="btn btn-primary"><i class="far fa-check-circle"></i> Event Selesai</button>
                </div>
            </form>
            </div>
        </div>
