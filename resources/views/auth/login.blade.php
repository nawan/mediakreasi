        ...
        <div class="container-fluid">  
            <div class="row pt-5">  
                <div class="col-md-5 col-lg-4 col-sm-6 mx-auto pt-5">
                    <div class="card align-middle bg-dark">
                        <div class="card-header fw-bold text-center text-capitalize text-light mb-2">
                            <h5>login dashboard admin</h5>
                        </div>
                        <div class="card-body mb-3">
                            <div class="text-center bg-gradient-gray-dark mb-5">
                                <img src="{{ URL::asset('/assets/img/mediakreasi-full.png') }}" class="navbar-brand-img" data-holder-rendered="true" height="auto" width="250px" />
                            </div>
